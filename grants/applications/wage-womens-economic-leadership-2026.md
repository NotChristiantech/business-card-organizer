...
Fund details in `../funders/wage.md`.

## Read this before drafting anything

### 1. Service delivery is ineligible

**Capacity building, service delivery, scaling and participant fees cannot be
funded.** This inverts how ACBN has won every other grant. The BEP concept paper
— accelerator, mentorship, cohorts, training — describes almost entirely
ineligible activity here.
...
Stated priority goes to women's organizations and Indigenous women's
organizations. As lead applicant ACBN starts behind.

**Decide deliberately whether ACBN should lead.** Options:

- **ACBN leads**, foregrounding 74% women constituency and women in senior
  management (the BEP application committed to 50%+). Simplest, weakest position.
- **A Black women's organization leads, ACBN as core partner.** Materially
  better odds. Pitch Better / FoundHers Innovation Labs is in Ryan's network and
  is exactly this. So is the Jean Augustine Centre for Girls.
- **Co-application**, if the fund permits it — confirm.
...
- [ ] Confirm women's representation in ACBN senior management and on the board —
      it will be asked

## Honest note on the timeline

Eleven days for a systemic-change application at up to $1.4M over 60 months is
tight. ACBN has submitted plenty at short notice, so it is possible — but a
rushed application in the mandate-adjacent category is the combination this
archive shows losing.

If the lead-applicant question cannot be settled quickly, the better decision
may be to pass, record why, and target the next cycle properly. That is a real
